    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-20 lg:max-w-4xl">
      ...
      <section className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          ...
          you use our website, as well as your privacy rights and how they are protected
          by law.
        </p>
      </section>
      ...
      <section className="mb-8 space-y-4">
        ...
        <ul className="text-muted-foreground list-inside list-disc space-y-2 pl-4">
          ...
          <li>
            <strong>Authentication Data:</strong> When you sign up, we collect necessary
      ...
      <section className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          We do not sell, lease, or trade your personal information. However, we may share
          your data with trusted third parties like to process payments or provide other
          services on our behalf. We ensure that all third-party providers we work with
          adhere to data protection standards, in compliance with relevant laws such as
          the Information Technology Act 2000 and Digital Personal Data Protection Act
          2023 under Indian law or any other applicable laws.
        </p>
      </section>
      ...
      <section className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          We have implemented suitable technical and organizational measures as per the
          level of risk to protect your personal data from unauthorized access, loss, or
          misuse.
        </p>
      </section>
      ...
      <section className="mb-8 space-y-4">
        ...
        <ul className="text-muted-foreground list-inside list-disc space-y-2 pl-4">
          ...
          <li>
            <strong>Correction:</strong> If any of your data is incorrect or incomplete,
            you can request to have it updated.
          </li>
          <li>
          ...
          <li>
            <strong>Restriction:</strong> You can ask us to restrict the use of your data
      ...
      <section className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          ...
          management. These cookies help maintain your login status and ensure secure
          access to your account. We do not use cookies for tracking or advertising
          purposes.
        </p>
      </section>
      ...
      <section className="mb-8 space-y-4">
        ...
        <p className="text-muted-foreground">
          We may update this privacy policy occasionally. Any changes will be posted here,
          and the effective date will be updated at this page. It shall be assumed that
          you are aware of any changes and accept the same.
        </p>
      </section>
