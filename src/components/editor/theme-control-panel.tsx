...
import type { ControlTab } from "@/hooks/use-controls-tab-from-url";
import type { FontInfo } from "@/types/fonts";
import type { ThemeEditorControlsProps, ThemeStyleProps } from "@/types/theme";
import { ChatHistorySidebar } from "@/app/(auth)/ai/components/chat-history-sidebar";
      ...
      <div className="flex min-h-0 flex-1 flex-col space-y-4">
        ...
        >
          <HorizontalScrollArea className="mt-2 mb-1 px-4">
            <TabsList className="bg-background text-muted-foreground inline-flex w-fit items-center justify-center space-x-1 rounded-full px-0">
