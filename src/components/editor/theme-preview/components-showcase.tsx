...
const ComponentsShowcase = ({ styles, currentMode }: ComponentsShowcaseProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Cards & Containers */}
      <section className="space-y-3">
        <h3 className="border-b pb-2 text-sm font-medium">Cards & Containers</h3>
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              <p className="text-sm">
                This card demonstrates the card background and foreground colors, with
                content showing regular text.
              </p>
            </CardContent>
          ...
          <div className="space-y-3">
            ...
            >
              <h4 className="mb-2 text-sm font-medium">Popover Container</h4>
            ...
            >
              <h4 className="mb-2 text-sm font-medium">Muted Container</h4>
              <p className="text-xs">
      ...
      {/* Status Indicators */}
      <section className="space-y-3">
        <h3 className="border-b pb-2 text-sm font-medium">Status Indicators & Alerts</h3>
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                <h5 className="text-sm font-medium">Success Alert</h5>
      ...
      {/* Data Display */}
      <section className="space-y-3">
        <h3 className="border-b pb-2 text-sm font-medium">Data Display</h3>
        <Table>
          <TableHeader>
            <TableRow>
