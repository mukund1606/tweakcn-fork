...
const ResponsiveDialogContext = React.createContext<ResponsiveDialogContextProps | null>(
  null,
);
...
const ResponsiveDialogContentVariants = cva("bg-background fixed z-[9999]", {
  variants: {
    device: {
      desktop:
        "dark:!border-primary/10 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 top-1/2 left-1/2 grid max-h-[calc(100%-4rem)] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-transparent shadow-lg duration-200 sm:max-w-lg",
      mobile: "flex",
    },
    direction: {
      bottom: "",
  ...
  compoundVariants: [
    {
      ...
      direction: "bottom",
      className:
        "!border-primary/10 inset-x-0 bottom-0 mt-24 h-fit max-h-[75%] flex-col rounded-t-lg border border-b-0",
    },
    {
      device: "mobile",
      direction: "top",
      className:
        "!border-primary/10 inset-x-0 top-0 mb-24 h-fit max-h-[75%] flex-col rounded-b-lg border border-b-0",
    },
    {
      device: "mobile",
      direction: "left",
