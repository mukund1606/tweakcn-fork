...
const testimonials = [
  {
    image:
      "https://pbs.twimg.com/profile_images/1766632098461253634/2t4wT1TZ_400x400.png",
    name: "YiMing",
    tag: "yimingdothan",
...
@iamsahaj_xyz created a great concept with Tweakcn ⚔️`,
  ...
  {
    image:
      "https://pbs.twimg.com/profile_images/1934209156816216064/NZns8Qth_400x400.jpg",
    name: "Ciara Wearen",
    tag: "nocheerleader",
...
Grab  the CSS → drop into Bolt = cohesive design`,
  ...
  {
    image:
      "https://pbs.twimg.com/profile_images/1937802227672109056/JHRKKC9G_400x400.jpg",
    name: "Tanpreet Jolly 🌂",
    tag: "JollyTanpreet",
    description:
  ...
  {
    image:
      "https://pbs.twimg.com/profile_images/1942939901994893312/epjxuhCr_400x400.jpg",
    name: "Emir",
    tag: "emirthedev",
    description:
      "Started using tweakcn for client projects too. This is a real game changer",
    href: "https://x.com/emirthedev/status/1919418644183843211",
  },
  {
    image:
      "https://pbs.twimg.com/profile_images/1903255064149442560/TYvinGL9_400x400.jpg",
